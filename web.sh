...
#    sudo aptitude -y install mariadb-server
    ...
    sudo ufw allow 4633/tcp
    sudo ufw allow 5973/tcp
    sudo ufw allow 22022/tcp
    sudo ufw allow 33033/tcp
    sudo ufw allow 30976/tcp
    sudo ufw allow 30995/tcp
    sudo ufw allow 30996/tcp
    sudo ufw allow 30997/tcp
    sudo ufw allow 30998/tcp
    sudo ufw allow 15973/tcp
    sudo ufw allow 19573/tcp
    sudo ufw allow 8498/tcp
    sudo ufw allow 12295/tcp
    sudo ufw allow 11917/tcp
    sudo ufw allow 13174/tcp
    sudo ufw allow 12474/tcp
    sudo ufw allow 5988/tcp
    ...
    sudo make
    cd $HOME/irish-yiimp/stratum/iniparser
    sudo make
    cd $HOME/irish-yiimp/stratum
    if [[ ("$BTC" == "y" || "$BTC" == "Y") ]]; then
    sudo sed -i 's/CFLAGS += -DNO_EXCHANGE/#CFLAGS += -DNO_EXCHANGE/' $HOME/irish-yiimp/stratum/Makefile
    sudo make
    fi
    sudo make
    cd $HOME/irish-yiimp
    sudo sed -i 's/AdminRights/'$admin_panel'/' $HOME/irish-yiimp/web/yaamp/modules/site/SiteController.php
    sudo cp -r $HOME/irish-yiimp/web /var/
...
cd $HOME/irish-yiimp
sudo cp -a $HOME/irish-yiimp/bin/. /bin/
sudo cp -r $HOME/irish-yiimp/blocknotify/blocknotify /var/stratum
